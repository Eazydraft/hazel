...
module.exports = class Cache {
  constructor(config) {
    ...
    // Support multiple channels: test, beta, and stable
    this.channels = {
      test: {},
      beta: {},
      stable: {}
  ...
  detectChannel(version) {
    ...
    // version format: X.Y.Z or X.Y.Z-test.N or X.Y.Z-beta.N, etc.
  ...
  async refreshCache() {
    ...
    for (const item of data) {
      ...
      // Skip tags starting with 'v'
      if (item.tag_name && item.tag_name.startsWith('v')) {
        continue
      }
  ...
  async loadCache(channel = 'stable', version = null) {
